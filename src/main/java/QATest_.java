 ...
 * 11/10/2005   Andre Mermegas: added test for Historical Snapshot Closed Position Reports, common.Order Status Request
...
public class QATest_ {
    ...
    public QATest_(String aUsername, String aPassword, String aStation, String aServer, String aConfigFile) {
        mServer = aServer;
        mUsername = aUsername;
        mPassword = aPassword;
        mStation = aStation;
    ...
    private static void runTest(String[] aArgs) {
        ...
        QATest_ qaTest = new QATest_(aArgs[0], aArgs[1], aArgs[2], aArgs[3], arg5);
